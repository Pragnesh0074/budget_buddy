...
class _YearlySpendingsState extends State<YearlySpendings> {
  ...
  Widget build(BuildContext context) {
    ...
    final groupTransFirstSixMonths = trxData.firstSixMonthsTransValues(
      yearlyTrans,
      int.parse(_selectedYear),
    );
    final groupTransLastSixMonths = trxData.lastSixMonthsTransValues(
      yearlyTrans,
      int.parse(_selectedYear),
    );
